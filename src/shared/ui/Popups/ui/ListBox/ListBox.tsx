...
export const ListBox = <T extends string>({ className, items, value, onChange, defaultValue, label, readonly, direction = 'bottom right' }: ListBoxProps<T>) => {
  return (
    <HStack gap='8'>
      ...
      >
        ...
        <ListboxOptions transition className={classNames(classes.options, {}, [mapDirectionClass[direction]])}>
          {items?.map((item) => (
            <ListboxOption
